  ...
  try {
    ...
    switch (paramType) {
      ...
      case ParamType.SqliteRow:
        ...
        switch (T) {
          case GetallregistrosRow:
            return GetallregistrosRow(data);
          case FechaformateadaRow:
            return FechaformateadaRow(data);
          case GetAllActividadesRow:
            return GetAllActividadesRow(data);
          case LaboresRow:
            return LaboresRow(data);
          case CentrosDeCostoRow:
            return CentrosDeCostoRow(data);
          case ProyectosRow:
            return ProyectosRow(data);
          case GruposRow:
            return GruposRow(data);
          case PersonalRow:
            return PersonalRow(data);
          case GetAllTareosRow:
            return GetAllTareosRow(data);
          default:
            return null;
        }
