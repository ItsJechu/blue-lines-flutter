...
Future<void> generatePDFCopyCopy(
  ...
  pdf.addPage(
    pw.Page(
      pageFormat: PdfPageFormat.a4, // Usar formato A4
      build: (pw.Context context) {
        return pw.Center(
          child: pw.Container(
            width: 5 * PdfPageFormat.cm, // Mantener ancho de 5 cm
            height: 7 * PdfPageFormat.cm, // Mantener alto de 7 cm
            ...
            child: pw.Column(
              ...
              children: [
                ...
                pw.Text(
                  ...
                  style: pw.TextStyle(fontSize: 12), // Tamaño de la fuente
                ),
                pw.SizedBox(height: 5),
                pw.Text(
                  "Nombre: $cosechadornombre",
                  style: pw.TextStyle(fontSize: 10), // Tamaño de la fuente
                ),
                pw.Text(
                  "DNI: $cosechadordni",
                  style: pw.TextStyle(fontSize: 10), // Tamaño de la fuente
