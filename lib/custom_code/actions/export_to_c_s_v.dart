...
Future<void> exportToCSV() async {
  try {
    ...
    List<Map> registros = await database.query('registro_fitosanitaria');
    ...
    String filePath =
        '${documentsDirectory.path}/registro_fitosanitaria_$exportCounter.csv';
    ...
    final String newFilePath =
        '/storage/emulated/0/Download/registro_fitosanitaria_$exportCounter.csv';
...
String convertToCSV(List<Map> registros) {
  // Encabezado CSV
  String csv =
      'fecha,Variedad,Lote,Grupo,Valvula,Nro_Planta,Nro_Individuos,Plaga-Enfermedad\n';
  ...
  for (var registro in registros) {
    ...
    String plagEtapa = registro['plag_etapa'].trim();

    csv +=
        '$formattedDate,${registro['tipo_variedad']},${registro['lote']},${registro['valvula']},$plagEtapa,${registro['nro_planta']},${registro['grado']},${registro['enfermedad_plaga']}';
  }
