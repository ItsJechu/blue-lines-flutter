...
import 'reporte_tareos_model.dart';
export 'reporte_tareos_model.dart';

class ReporteTareosWidget extends StatefulWidget {
  const ReporteTareosWidget({
    super.key,
    this.userProfile,
    this.usersAppointment,
    this.cosechadorappointment,
  });

  final DocumentReference? userProfile;
  final String? usersAppointment;
  final List<String>? cosechadorappointment;

  @override
  State<ReporteTareosWidget> createState() => _ReporteTareosWidgetState();
}

class _ReporteTareosWidgetState extends State<ReporteTareosWidget>
    with TickerProviderStateMixin {
  late ReporteTareosModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ReporteTareosModel());
                            ...
                            Expanded(
                              child: Padding(
                                padding: const EdgeInsetsDirectional.fromSTEB(
                                    0.0, 8.0, 0.0, 0.0),
                                child: Text(
                                  'Registra la información sobre el tareo del personal',
                                  style: FlutterFlowTheme.of(context)
                                      .bodySmall
                                      .override(
                                        fontFamily: 'Outfit',
