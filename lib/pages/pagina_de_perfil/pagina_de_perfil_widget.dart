  ...
  Widget build(BuildContext context) {
    return StreamBuilder<UsersRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final paginaDePerfilUsersRecord = snapshot.data!;
                          ...
                          children: [
                                  ...
                                  Card(
                                    ...
                                    child: Padding(
                                      ...
                                      child: Container(
                                        ...
                                        child: Image.network(
                                          paginaDePerfilUsersRecord.photoUrl,
                                        ),
                                      ),
                                    ),
                                  ),
                            ...
                            Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  Text(
                                    paginaDePerfilUsersRecord.displayName,
                                  ...
                                  Padding(
                                    padding: const EdgeInsetsDirectional.fromSTEB(
                                        4.0, 0.0, 0.0, 0.0),
                                    child: Text(
                                      paginaDePerfilUsersRecord.age.toString(),
                                      style: FlutterFlowTheme.of(context)
                                          .titleMedium
                                          .override(
                                            fontFamily: 'Outfit',
                              ...
                              children: [
                                Padding(
                                  padding: const EdgeInsetsDirectional.fromSTEB(
                                      0.0, 8.0, 0.0, 0.0),
                                  child: Text(
                                    paginaDePerfilUsersRecord.email,
                                    style: FlutterFlowTheme.of(context)
                                        .bodyMedium
                                        .override(
                                          fontFamily: 'Outfit',
                            ...
                            Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  Expanded(
                                    child: AutoSizeText(
                                      paginaDePerfilUsersRecord.ailments,
                                      style: FlutterFlowTheme.of(context)
                                          .headlineSmall
                                          .override(
                                            fontFamily: 'Outfit',
