...
import 'historialasistencia_model.dart';
export 'historialasistencia_model.dart';
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<AsistenciaRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<AsistenciaRecord> historialasistenciaAsistenciaRecordList =
            snapshot.data!;
              ...
              children: [
                    ...
                    onFieldSubmitted: (_) async {
                      safeSetState(() {
                        _model.simpleSearchResults = TextSearch(
                          historialasistenciaAsistenciaRecordList
                              .map(
                ...
                Expanded(
                  child: StreamBuilder<List<AsistenciaRecord>>(
                    stream: queryAsistenciaRecord(
                      queryBuilder: (asistenciaRecord) => asistenciaRecord
                          .where(
                            'asistenciapersona',
                            isEqualTo: currentUserReference,
                          )
                          .orderBy('checkin')
                          .orderBy('cosechadores'),
                    ),
                    builder: (context, snapshot) {
                      // Customize what your widget looks like when it's loading.
                      if (!snapshot.hasData) {
                      ...
                      List<AsistenciaRecord> listViewAsistenciaRecordList =
                          snapshot.data!;
                      if (listViewAsistenciaRecordList.isEmpty) {
                        return const Center(
                            ...
                            child: InkWell(
                              ...
                              onTap: () async {
                                context.pushNamed(
                                  'asistenciadetalles',
                                  queryParameters: {
                                    'asistenciaDetails': serializeParam(
                                      listViewAsistenciaRecord.reference,
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      InkWell(
                                        ...
                                        highlightColor: Colors.transparent,
                                        onTap: () async {
                                          await listViewAsistenciaRecord
                                              .reference
                                              .delete();
                                        },
                                        child: const Icon(
