...
import 'marcar_horaentrada_model.dart';
export 'marcar_horaentrada_model.dart';

class MarcarHoraentradaWidget extends StatefulWidget {
  const MarcarHoraentradaWidget({
    super.key,
    required this.fundo,
  });
  ...
  @override
  State<MarcarHoraentradaWidget> createState() =>
      _MarcarHoraentradaWidgetState();
}

class _MarcarHoraentradaWidgetState extends State<MarcarHoraentradaWidget> {
  late MarcarHoraentradaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MarcarHoraentradaModel());
                                ...
                                builder: (context, snapshot) {
                                  ...
                                  return FFButtonWidget(
                                    onPressed: () async {
                                      ...
                                      _model.salidadetrabajador =
                                          await queryCosechadoresRecordOnce(
                                        queryBuilder: (cosechadoresRecord) =>
                                            cosechadoresRecord.where(
                                          'nombrescosechador',
                                          isEqualTo: _model.cosechadorname,
                                        ),
                                        singleRecord: true,
                                      ).then((s) => s.firstOrNull);
                                      shouldSetState = true;
                                      ...
                                      await asistenciaRecordReference.set({
                                        ...createAsistenciaRecordData(
                                          cosechadores:
                                              '${_model.cosechadorname}${_model.textController.text}',
                                          asistenciapersona:
                                              currentUserReference,
                                          creationTime:
                                              functions.getTodayFirstHourCopy(),
                                          fundo: widget.fundo,
                                          dnicosechador: _model
                                              .salidadetrabajador
                                              ?.dnicosechador,
                                        ),
                                        ...mapToFirestore(
